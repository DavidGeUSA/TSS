...
public:
	...
	void setFieldsMemory(Point3Dstruct *f, Point3Dstruct *pNextCurl){ Field = f; pNext = pNextCurl; }
	void calculateCurl();
	//
	...
	//test
	double DxVx(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	double DyVy(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	double DzVz(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	//
	double DyVx(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	double DzVy(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	double DxVz(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	//
	double DzVx(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	double DxVy(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	double DyVz(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0);
	//
	double Divergence(Point3Dstruct *f, unsigned int i0, unsigned int j0, unsigned int k0, size_t w0);
	int _getNextCurlUseFastMethod(Point3Dstruct *pCurrent, Point3Dstruct *pNextCurl);
};
